def main():
    ...
    investment += investment * interest_rate
    investment += investment * interest_rate
    print('After 5 years, your investment will be worth ' + str(investment) + ' dollars.')         # error was found on this line, error was as follows: "can only concatenate str (not "float") to str"
